...
(function () {
    ...
    function getRangeDisplayText(range) {
        switch (range) {
            case 'all':     return { upload: 'Uploaded All Time',        patients: 'New Patients All Time' };
            case 'today':   return { upload: 'Uploaded Today',            patients: 'New Patients Today' };
            case 'weekly':  return { upload: 'Uploaded Weekly',           patients: 'New Patients Weekly' };
            case 'monthly': return { upload: 'Uploaded Monthly',          patients: 'New Patients Monthly' };
            case 'yearly':  return { upload: 'Uploaded Yearly',           patients: 'New Patients Yearly' };
            case 'custom':  return { upload: 'Uploaded (Custom Range)',   patients: 'New Patients (Custom Range)' };
            default:        return { upload: 'Uploaded',                  patients: 'New Patients' };
        }
    }

    function updateDynamicLabels(range) {
        const labels = getRangeDisplayText(range);
        setText('#kpiDocsTodayLabel', labels.upload);
    ...
    function updateKPIs(data) {
        ...
        setText('#kpiDocsToday', fmt(data.documentsUploadedToday ?? data.DocumentsUploadedToday));

...
namespace DMS_CPMS.Areas.SuperAdmin.Controllers
{
    ...
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateAccountViewModel model)
        {
            ...
            await _auditLogService.LogAsync("Create Account", details: $"Target: {user.UserName} ({model.RoleType})");
        ...
        public async Task<IActionResult> Edit(EditAccountViewModel model)
        {
            ...
            var roleChanged = currentRole != null && !string.Equals(currentRole, model.RoleType, StringComparison.OrdinalIgnoreCase);
            if (roleChanged)
            {
            ...
            await _auditLogService.LogAsync(
                roleChanged ? $"Update Account (Role: {currentRole} → {model.RoleType})" : "Update Account",
                user.Id,
